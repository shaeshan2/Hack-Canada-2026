          ...
          <div className="deedy-body" ref={bodyRef}>
            {messages.length === 0 && (
              <div className="deedy-welcome">
                <span className="deedy-welcome-icon">
                  <Bot size={28} strokeWidth={1.5} />
                </span>
                <h3>DeedScan Assistant</h3>
                <p>
                  How can I help you with DeedScan listings, prices, or
                  verification today?
                </p>
                <div className="deedy-suggestions">
                  <button
                    onClick={() =>
                      void sendMessage("What listings are available?")
                    }
                  >
            ...
            {messages.map((msg, i) => (
              ...
              >
                {msg.role === "model" && (
                  <span className="deedy-msg-avatar">
